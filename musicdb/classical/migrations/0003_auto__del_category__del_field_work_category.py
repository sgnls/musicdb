...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('classical_work', 'category_id')

    def backwards(self, orm):
        # Adding model 'Category'
        db.create_table('classical_category', (
            ('long_name', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True)),
        ...
        db.add_column('classical_work', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='works', null=True, to=orm['classical.Category'], blank=True),
                      keep_default=False)
