...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('nonclassical_album', 'cover')

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Album.cover'
        raise RuntimeError("Cannot reverse this migration. 'Album.cover' and its values cannot be restored.")
    models = {
        'albums.album': {
