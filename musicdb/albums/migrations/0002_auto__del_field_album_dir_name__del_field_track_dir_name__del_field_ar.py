...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Album.dir_name'
        db.delete_column('nonclassical_album', 'dir_name')

        # Deleting field 'Track.dir_name'
        db.delete_column('nonclassical_track', 'dir_name')

        # Deleting field 'Artist.dir_name'
        db.delete_column('nonclassical_artist', 'dir_name')

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Album.dir_name'
        raise RuntimeError("Cannot reverse this migration. 'Album.dir_name' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Track.dir_name'
        raise RuntimeError("Cannot reverse this migration. 'Track.dir_name' and its values cannot be restored.")
