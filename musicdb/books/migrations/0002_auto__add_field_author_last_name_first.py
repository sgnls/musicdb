...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Author.last_name_first'
        db.add_column('books_author', 'last_name_first',
                      self.gf('django.db.models.fields.TextField')(default='h', max_length=1, db_index=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Author.last_name_first'
        db.delete_column('books_author', 'last_name_first')
