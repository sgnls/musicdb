...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MobiFile'
        db.create_table(u'books_mobifile', (
            ('book', self.gf('django.db.models.fields.related.OneToOneField')(related_name='mobi', unique=True, primary_key=True, to=orm['books.Book'])),
            ('file', self.gf('django.db.models.fields.related.OneToOneField')(related_name='book_mobi', unique=True, to=orm['common.File'])),
        ))
        db.send_create_signal(u'books', ['MobiFile'])

    def backwards(self, orm):
        # Deleting model 'MobiFile'
        db.delete_table(u'books_mobifile')
