...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('books_author', 'slug',
                      self.gf('django.db.models.fields.TextField')(default='hitchens-christopher', max_length=100, db_index=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Author.slug'
        db.delete_column('books_author', 'slug')
